...
export default function ProductHeader({ cartCount = 0 }: { cartCount?: number }) {
    ...
    <header className="sticky top-0 z-40 border-b border-[#1b1e2b] bg-[rgba(10,10,15,0.92)] backdrop-blur-xl">
      ...
      <div className="border-t border-[#1b1e2b] bg-[rgba(10,10,15,0.98)] md:hidden">
        <div className="mx-auto flex max-w-[1240px] flex-wrap items-center justify-center gap-x-8 gap-y-3 px-4 py-3">
          <Link href="/homepage" className="text-[13px] uppercase tracking-[0.16em] text-[#a7aec4] hover:text-[#d6c7ff]">
            Home
          </Link>
          <Link href="/collection" className="text-[13px] uppercase tracking-[0.16em] text-[#d6c7ff]">
            Collection
          </Link>
