            ...
            <div className="relative z-10 flex h-full flex-col justify-between">
              <div>
                ...
                <h1 className="mt-4 max-w-[460px] text-[42px] font-semibold leading-tight tracking-[-0.05em] text-white">
                  Recover Delivery Access Securely
                </h1>

                <p className="mt-4 max-w-[460px] text-[14px] leading-7 text-[#a7aec4]">
                  Enter the registered delivery email address and receive a
                  secure password reset link in your inbox.
                </p>
              </div>
              ...
              <div className="grid gap-3">
                <div className="rounded-[20px] border border-white/10 bg-white/[0.04] p-4">
                  ...
                  <div className="mt-1 text-[12px] leading-5 text-[#a7aec4]">
                    Reset links are sent only to registered delivery emails.
                  </div>
                </div>
                ...
                <div className="rounded-[20px] border border-white/10 bg-white/[0.04] p-4">
                  ...
                  <div className="mt-1 text-[12px] leading-5 text-[#a7aec4]">
                    Unauthorized users cannot access the protected delivery
                    dashboard.
                  </div>
                </div>
              </div>
          ...
          <section className="p-5 sm:p-8 lg:p-10">
            <div className="mb-8">
              ...
              <p className="mt-2 max-w-[420px] text-[13px] leading-6 text-[#a7aec4]">
                Enter your delivery account email and we’ll send you a password
                reset link.
              </p>
            </div>
            ...
            <p className="mt-8 text-center text-[12px] leading-6 text-[#7f879f]">
              Use only the email address registered for your delivery account.
            </p>
          </section>
        </div>
      </div>
